...
echo "  <script type=\"text/javascript\" src=\"/user/qos_conntrack.js\"></script>"
...
echo "   </fieldset><br />"
echo "   <fieldset>"
echo "    <legend>Active Connections (<span id=\"conRefresh\" a href=\"#\" onclick=\"confresh()\">PAUSE</span>)</legend>"
...
echo "     <p>You can add more protocols to the known list simply by editing the qos_conntrack.js file on your router."
